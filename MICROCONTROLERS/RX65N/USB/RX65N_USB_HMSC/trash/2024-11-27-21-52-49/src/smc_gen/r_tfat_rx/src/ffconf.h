...
#include "platform.h"    /* Renesas modify */
...
#if BSP_CFG_RTOS_USED == 0               /* Renesas modify */
#define FF_FS_REENTRANT	0
#elif BSP_CFG_RTOS_USED == 1             /* FreeRTOS */
#define FF_FS_REENTRANT	1
#define FF_SYNC_t		SemaphoreHandle_t
/* When FreeRTOS, FF_FS_TIMEOUT means time-out (ms) which is converted time ticks, 
/  the argument "xTicksToWait" of the service call "xSemaphoreTake", to times by 
/  pdMS_TO_TICKS macro. */
...
#define FF_FS_REENTRANT	1
#define FF_SYNC_t	ID
/* When Renesas ITRON OS, FF_FS_TIMEOUT means time-out (ms) which is the argument "tmout" 
/  of the service call "wait_sem". */
#define FF_FS_TIMEOUT	1000
#else                                    /* Other RTOS */
#error "Not Support: Other RTOS with TFAT"
#endif                                   /* Renesas modify */
