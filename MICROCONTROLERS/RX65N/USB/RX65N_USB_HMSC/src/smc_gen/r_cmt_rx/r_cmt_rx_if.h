...
*         : 15.08.2022 5.40    Added support for RX26T.
*                              Fixed to comply with GSCE Coding Standards Rev.6.5.0.
*         : 29.08.2022 5.50    Added support for RX23E-B.
*         : xx.xx.2022 5.60    Updated macro definition enable and disable nested interrupt for CMT.
***********************************************************************************************************************/
