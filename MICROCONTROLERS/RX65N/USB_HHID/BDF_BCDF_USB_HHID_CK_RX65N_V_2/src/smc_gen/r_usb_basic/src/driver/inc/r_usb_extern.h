...
extern uint8_t  *gp_usb_hstd_data_ptr[1][USB_MAX_PIPE_NO + 1u];  /* PIPEn Buffer pointer(8bit) */
...
/* r_usb_hmanager.c */
extern uint16_t g_usb_hstd_enum_seq[1];                          /* Enumeration request */
extern uint16_t g_usb_hstd_device_descriptor[1][USB_DEVICESIZE / 2u];
extern uint16_t g_usb_hstd_config_descriptor[1][USB_CONFIGSIZE / 2u];
extern uint16_t g_usb_hstd_suspend_pipe[1][USB_MAX_PIPE_NO + 1u];
extern uint16_t g_usb_hstd_check_enu_result[1];                  /* Enumeration result check */
extern uint8_t g_usb_hstd_class_data[1u][CLSDATASIZE];
