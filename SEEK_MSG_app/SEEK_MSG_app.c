...
char msg2[] = "mfdanlhgh, fdanlyyy, aaanly, ghanlvb";
char seek[] = "anl";
char replace[] = "xxxx";
...
int main(){
    Find(msg2, seek, sizeof(msg2), sizeof(seek), '|');
    Replace(msg2, seek, sizeof(msg2), sizeof(seek), '|', replace, sizeof(replace));
